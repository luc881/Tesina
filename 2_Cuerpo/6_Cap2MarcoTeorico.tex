...
En este proyecto se utiliza el \textbf{NETUM CS7501}, un escáner portátil e inalámbrico que se comunica con el equipo del punto de venta mediante un receptor USB o por Bluetooth. Al no depender de un cable, el empleado puede acercar el lector al producto en lugar de llevar cada artículo hasta el equipo de cómputo, y el dispositivo opera con una batería recargable.

\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=0.5\textwidth]{0_imagenes/Cap2MarcoTeorico/NetumCS7501.png}}
    \caption{Lector de códigos de barras NETUM CS7501}
    \label{fig:cap2-netum-cs7501}

    \vspace{0.2cm}
    \footnotesize \textbf{Fuente:} NETUM, \url{https://www.netum.net/}
\end{figure}

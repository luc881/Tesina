...
El ESP32 se programa utilizando los lenguajes \textbf{C++}, debido a que permiten un control directo sobre el hardware y optimizan el uso de recursos del microcontrolador. Estos lenguajes son ampliamente utilizados en sistemas embebidos por su eficiencia y capacidad de manejar tareas de ejecución continua, como la lectura de sensores, el control de periféricos y la comunicación con el backend del sistema.

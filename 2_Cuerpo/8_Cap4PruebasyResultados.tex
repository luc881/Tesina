...
\begin{figure}[H]
   \centering
   \fbox{\includegraphics[width=0.65\textwidth]{0_imagenes/Cap4/RailwayDashboard.png}}
...
%\begin{figure}[H]
%    \centering
%    \fbox{\includegraphics[width=\textwidth]{0_imagenes/Cap4/ModoLector.png}}
...
%\begin{figure}[H]
%    \centering
%    \fbox{\includegraphics[width=0.9\textwidth]{0_imagenes/Cap4/MonitorSensor.png}}
...
% TODO: insertar captura de pantalla del dashboard de Vercel mostrando el proyecto activo
% Guardar en: 0_imagenes/Cap4/VercelDashboard.png
%\begin{figure}[H]
%    \centering
%    \fbox{\includegraphics[width=0.85\textwidth]{0_imagenes/Cap4/VercelDashboard.png}}

...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=0.9\textwidth]{0_imagenes/Avances1/BDCompleta.png}}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=0.5\textwidth]{0_imagenes/Avances1/BDUsuarios.png}}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=\textwidth]{0_imagenes/Avances1/DatosExcel.png}}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=0.5\textwidth]{0_imagenes/Avances1/DatosJSON.png}}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=0.8\textwidth]{0_imagenes/Avances1/APIDominio.png}}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=\textwidth]{0_imagenes/Avances1/APIComparativo.png}}
...
La interfaz web se conecta directamente con la API del sistema para obtener y enviar información de forma inmediata. Cada acción realizada por el usuario genera una solicitud al backend, el cual procesa la operación correspondiente y devuelve la respuesta que se muestra en pantalla.

\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=0.6\textwidth]{0_imagenes/Avances1/FRONTENDJSON.png}}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=0.7\textwidth]{0_imagenes/Avances1/FRONTENDUI.png}}

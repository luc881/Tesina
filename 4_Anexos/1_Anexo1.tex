...
Implementar lógica de negocio, estructura de BD y comunicación con la interfaz web e IoT. \\
\hline

Desarrollador de la Interfaz Web &
...
Programar el ESP32 para lectura del sensor AHT10 y envío de datos al servidor. \\
\hline
...
Pantallas OLED SSD1306 & 3 &
Pantalla monocromática de 128×64 píxeles con interfaz I²C. Cada una muestra un dato distinto del nodo sensor: temperatura, humedad relativa y estado de conexión. \\
\hline
...
Visual Studio Code &
Entorno de desarrollo utilizado principalmente para la desarrollo de la interfaz web con React y la gestión general de archivos del proyecto. &
Software \\
\hline
...
Formato ligero de intercambio de datos utilizado para transmitir información estructurada entre la aplicación web, el servidor y otros componentes del sistema mediante la API. &
Estándar de datos \\
\hline
...
\pgfmathsetmacro{\OLEDPrecio}{80}
\pgfmathsetmacro{\OLEDTotal}{\OLEDPrecio * 3}
...
\pgfmathsetmacro{\HardwareTotal}{%
  \ESPPrecio + \SensorPrecio + \OLEDTotal + \ScannerPrecio +
...
% SERVICIOS CLOUD
% ===============================
Vercel (Hosting Aplicación Web, Pro) & \num{360} & 1 & 0 & \num{\VercelMensual} & \num{\VercelAnual} \\
\hline
Railway (Hosting Servidor + Base de Datos) & \num{360} & 1 & 0 & \num{\RailwayMensual} & \num{\RailwayAnual} \\
\hline
...
En segundo lugar, contribuye a la conservación de la calidad de los medicamentos al integrar sensores de temperatura y humedad que supervisan las condiciones de almacenamiento. Este monitoreo continuo mantiene buena actualización de los productos en buen estado y favorece el cumplimiento de buenas prácticas farmacéuticas.

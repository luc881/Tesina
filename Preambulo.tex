...
\setlength{\emergencystretch}{3em} % Evita overfull hbox en párrafos con texto monoespaciado largo
\raggedbottom % Evita que LaTeX estire el espacio vertical para llenar páginas
...
\sisetup{
    ...
    round-precision = 2,         % Usar 2 decimales (ya añade .00 a enteros por defecto)
}
